...
_RELATIONSAMPLINGREQUEST_SAMPLINGSTAGE = _RELATIONSAMPLINGREQUEST.nested_types_by_name[
    "SamplingStage"
]
_RELATIONSAMPLINGREQUEST_RELATION = _RELATIONSAMPLINGREQUEST.nested_types_by_name["Relation"]
_RELATIONSAMPLINGREQUEST_RELATIONSTAGE = _RELATIONSAMPLINGREQUEST.nested_types_by_name[
    "RelationStage"
]
_RELATIONSAMPLINGRESPONSE = DESCRIPTOR.message_types_by_name["RelationSamplingResponse"]
_RELATIONSAMPLINGRESPONSE_SAMPLERESULT = _RELATIONSAMPLINGRESPONSE.nested_types_by_name[
    "SampleResult"
]
_RELATIONSAMPLINGRESPONSE_RESPONSEDATA = _RELATIONSAMPLINGRESPONSE.nested_types_by_name[
    "ResponseData"
]
...
SamplingConf = _reflection.GeneratedProtocolMessageType(
    "SamplingConf",
    (_message.Message,),
    {
...
FileFormatConf = _reflection.GeneratedProtocolMessageType(
    "FileFormatConf",
    (_message.Message,),
    {
...
RelationSamplingRequest = _reflection.GeneratedProtocolMessageType(
    "RelationSamplingRequest",
    (_message.Message,),
    {
        "SamplingStage": _reflection.GeneratedProtocolMessageType(
            "SamplingStage",
            (_message.Message,),
            {
        ...
        "RelationStage": _reflection.GeneratedProtocolMessageType(
            "RelationStage",
            (_message.Message,),
            {
...
RelationSamplingResponse = _reflection.GeneratedProtocolMessageType(
    "RelationSamplingResponse",
    (_message.Message,),
    {
        "SampleResult": _reflection.GeneratedProtocolMessageType(
            "SampleResult",
            (_message.Message,),
            {
...
HookMessage = _reflection.GeneratedProtocolMessageType(
    "HookMessage",
    (_message.Message,),
    {
